...
export default (threeHelper, level) => {
  ...
  function listenForEvents() {
    ...
    renderer.domElement.addEventListener('mousedown', _ => {isMouseDown = true});  
    renderer.domElement.addEventListener('mouseup', _ => {isMouseDown = false});  
    ...
    renderer.domElement.addEventListener('mousemove', e => {
      ...
      const currentMousePos = {x: e.x, y: e.y}
